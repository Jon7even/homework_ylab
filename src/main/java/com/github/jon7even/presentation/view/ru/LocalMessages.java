...
public class LocalMessages {
    ...
    public static final String MAIN_MENU_DIARY = "Вы в главном меню своего дневника. Выберите пункт меню: \n"
            ...
            + "3.Выйти из аккаунта\n"
            + "0.Завершить работу с приложением\n";
    public static final String MENU_DIARY_CREATE_STEP1 = "Самое время создать новый дневник! "
            + "Напишите ваш вес в формате [00.000]кг :";
    public static final String MENU_DIARY_CREATE_STEP2 = "Поехали дальше!"
            + "Напишите ваш рост в формате [00.0]см :";
    public static final String MENU_DIARY_CREATE_HOLD = "Создаем новый дневник. Ожидайте...";
    public static final String MENU_DIARY_CREATE_DONE = "Дневник создан! Поздравляем, вы восхитительны.";
    public static final String MENU_DIARY_NOT_FOUND = "Так у вас не создан дневник... Давайте создадим:)";
    public static final String MENU_DIARY_NOT_FAILURE = "Опаньки, а как это вы сюда попали?";
    public static final String MENU_DIARY_VIEW = "Давайте посмотрим ваш дневник...\n"
            + "-----------------------------------------------------------------------\n"
            + "| Ваш вес составляет %.03fкг | Ваш рост составляет %.01fсм "
            + "| Вы начали пользоваться приложением %s | А занимались в прошлый раз %s |\n"
            + "-----------------------------------------------------------------------\n";
    public static final String MENU_DIARY_VIEW_END = "С дневником закончили, что дальше? Выберите пункт меню: \n"
