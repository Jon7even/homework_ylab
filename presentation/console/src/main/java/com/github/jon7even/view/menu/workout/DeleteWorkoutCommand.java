...
public class DeleteWorkoutCommand extends ServiceCommand {
    ...
    public void handle() {
        ...
        System.out.println(LocalMessages.WORKOUT_DELETE_MENU);
        ...
        if (!listExistsWorkoutsByUser.isEmpty()) {
            ...
            if (getWorkoutService().isExistWorkoutByWorkoutId(workoutId)) {
                ...
                System.out.println(LocalMessages.WORKOUT_DELETE_PREPARE);
                getWorkoutService().deleteWorkoutByWorkoutIdAndOwnerId(workoutId, userId);
                getHistoryUserService().createHistoryOfUser(HistoryUserCreateDto.builder()
                        .userId(userId)
                        .event("Успешное удаление тренировки workoutId=" + workoutId)
                        .build());
                System.out.println(LocalMessages.WORKOUT_DELETE_COMPLETE);
            } else {
                getHistoryUserService().createHistoryOfUser(HistoryUserCreateDto.builder()
                        .userId(userId)
