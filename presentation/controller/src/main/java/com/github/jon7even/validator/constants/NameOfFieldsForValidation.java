package com.github.jon7even.validator.constants;

import lombok.AccessLevel;
import lombok.NoArgsConstructor;

/**
 * Утилитарный класс хранения постоянных имен полей для валидации
 *
 * @author Jon7even
 * @version 1.0
 */
@NoArgsConstructor(access = AccessLevel.PRIVATE)
public final class NameOfFieldsForValidation {
    public static final String OBJECT_DTO = "Object DTO";
    ...
    public static final String USER_WEIGHT = "weightUser";
    public static final String USER_GROWTH = "growthUser";
